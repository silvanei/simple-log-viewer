        ...
        $this->assertEquals(
            ...
            <div class="log-entry">
                ...
                <div class="log-content collapsed" data-json="">
                    <pre>  <span class="highlight-key">datetime</span>: <span class="highlight-string">"2025-05-17T16:39:03+00:00"</span>
              <span class="highlight-key">channel</span>: <span class="highlight-string">"test"</span>
              <span class="highlight-key">level</span>: <span class="highlight-string">"debug"</span>
              <span class="highlight-key">message</span>: <span class="highlight-string">"hello"</span>
              <span class="highlight-key">context</span>: <button _="on click toggle .highlight-toggle-display on next .highlight-toggle then toggle .rotate-180 on first in me">
            ...
            </span></span>  <span class="highlight-key">extra</span>: <button _="on click toggle .highlight-toggle-display on next .highlight-toggle then toggle .rotate-180 on first in me">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 icon-toggle" viewBox="0 0 20 20" fill="currentColor" width="16">
                    <path 
                        fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" 
                        clip-rule="evenodd"
            ...
            <span class="highlight-toggle-display highlight-toggle">    <span class="highlight-key">memory_peak_usage</span>: <span class="highlight-string">"4 MB"</span>
            </span></pre>
